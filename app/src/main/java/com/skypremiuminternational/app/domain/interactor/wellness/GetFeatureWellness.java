...
public class GetFeatureWellness extends UseCase<FeatureProduct, FeatureProductRequest> {

  private final ProductUtil productUtil;

  @Inject
  protected GetFeatureWellness(DataManager dataManager, ThreadExecutor subscriberThread,
  ...
  public Observable<FeatureProduct> provideObservable(FeatureProductRequest params) {
    return getDataManager().getFeatureWellness(params)
