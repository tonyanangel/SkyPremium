...
public class GetFeatureShopping extends UseCase<FeatureProduct, FeatureProductRequest> {

  private final ProductUtil productUtil;

  @Inject
  protected GetFeatureShopping(DataManager dataManager, ThreadExecutor subscriberThread,
  ...
  public Observable<FeatureProduct> provideObservable(FeatureProductRequest params) {
    return getDataManager().getFeatureShopping(params)
