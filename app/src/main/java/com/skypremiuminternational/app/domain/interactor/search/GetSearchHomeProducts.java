...
public class GetSearchHomeProducts extends UseCase<SearchProductResponse, SearchProductRequest> {

  private final ProductUtil productUtil;

  @Inject
  protected GetSearchHomeProducts(DataManager dataManager, ThreadExecutor subscriberThread,
  ...
  public Observable<SearchProductResponse> provideObservable(SearchProductRequest params) {
    return getDataManager().searchHomeProducts(params)
