...
public class GetWineAndDine extends UseCase<ProductListResponse, ProductListRequest> {

  private final ProductUtil productUtil;

  @Inject
  protected GetWineAndDine(DataManager dataManager, ThreadExecutor subscriberThread,
  ...
  public Observable<ProductListResponse> provideObservable(ProductListRequest params) {
    return getDataManager().getWineAndDine(params).flatMap(response -> Observable.from(response.getItems())
