...
public class GetTreeCategoryById extends UseCase<ResponseBody, String> {

        @Inject
        protected GetTreeCategoryById(DataManager dataManager, ThreadExecutor subscriberThread,
        ...
        public Observable<ResponseBody> provideObservable(String request) {
            return getDataManager().getTreeCategoryById(request).doOnNext(responseBody -> {
