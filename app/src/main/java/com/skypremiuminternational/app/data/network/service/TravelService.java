...
public interface TravelService {
  ...
  @GET(URL.TRAVEL)
  Observable<ProductListResponse> getTravel(@Header("Authorization") String auth,
  ...
  @Headers("Content-Type: application/json")
  @GET(URL.TRAVEL)
  Observable<ProductListResponse> getTravelByPopularity(@Header("Authorization") String auth,
                                                        @Query("searchCriteria[filterGroups][0][filters][0][value]") String category_id,
  ...
  @Headers("Content-Type: application/json")
  @GET(URL.TRAVEL)
  Observable<ProductListResponse> getTravelByPrice(@Header("Authorization") String auth,
                                                        @Query("searchCriteria[filterGroups][0][filters][0][value]") String category_id,
                                                        @Query("searchCriteria[sortOrders][0][field]") String popField,
                                                        @Query("searchCriteria[sortOrders][0][direction]") String popDirection,
                                                        @Query("searchCriteria[sortOrders][2][field]") String defaultField,
                                                        @Query("searchCriteria[sortOrders][2][direction]") String defaultDirection);

  @Headers("Content-Type: application/json")
  @GET(URL.FEATURE_TRAVEL)
  Observable<FeatureProduct> getFeatureTravel(@Header("Authorization") String auth,
