...
public interface WineAndDineService {

  @Headers("Content-Type: application/json")
  @GET(URL.WINE_AND_DINE)
  Observable<ProductListResponse> getWineAndDine(@Header("Authorization") String auth,
  ...
  @Headers("Content-Type: application/json")
  @GET(URL.WINE_AND_DINE)
  Observable<ProductListResponse> getWineAndDineByPopularity(@Header("Authorization") String auth,
                                                             @Query("searchCriteria[filterGroups][0][filters][0][value]") String category_id,
  ...
  @Headers("Content-Type: application/json")
  @GET(URL.FEATURE_WINE_AND_DINE)
  Observable<FeatureProduct> getFeatureWineAndDine(@Header("Authorization") String auth,
