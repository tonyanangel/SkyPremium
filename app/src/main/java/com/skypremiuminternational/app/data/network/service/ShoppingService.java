...
public interface ShoppingService {
  ...
  @GET(URL.SHOPPING)
  Observable<ProductListResponse> getShopping(@Header("Authorization") String auth,
  ...
  @Headers("Content-Type: application/json")
  @GET(URL.SHOPPING)
  Observable<ProductListResponse> getShoppingByPopularity(@Header("Authorization") String auth,
                                                          @Query("searchCriteria[filterGroups][0][filters][0][value]") String category_id,
  ...
  @Headers("Content-Type: application/json")
  @GET(URL.FEATURE_SHOPPING)
  Observable<FeatureProduct> getFeatureShopping(@Header("Authorization") String auth,
