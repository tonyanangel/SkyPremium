...
import com.skypremiuminternational.app.data.aws.encoding.URLEncoding;
...
class CanonicalRequest {
  ...
  CanonicalRequest(String service, HttpRequest httpRequest,
                   CanonicalHeaders headers, String contentSha256) {
  ...
  private static String normalizeQuery(String rawQuery) {
     ...
     * AWS)
     */
    Collections.sort(parameters, (o1, o2) -> o1.name.compareTo(o2.name));
