...
public abstract class ResetPasswordViewState {
  ...
  public static ResetPasswordViewState create(Throwable error, boolean isLoading, boolean isSuccess,
                                              String message) {
  ...
  public static Builder builder() {
    return new AutoValue_ResetPasswordViewState.Builder();
  }
  ...
  public abstract static class Builder {
    ...
    public abstract ResetPasswordViewState build();
  }
}
