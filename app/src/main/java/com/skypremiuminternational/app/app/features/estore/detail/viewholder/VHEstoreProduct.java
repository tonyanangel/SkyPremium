...
public class VHEstoreProduct extends RecyclerView.ViewHolder {
  ...
  public VHEstoreProduct(View itemView,IOnClickAddToCart onClickItemListener,IOnClickBuyNow onClickBuyNowListener) {
    super(itemView);
    ButterKnife.bind(this, itemView);
    this.onClickItemListener  = onClickItemListener;
    this.onClickBuyNowListener  = onClickBuyNowListener;
  }
  public VHEstoreProduct(View itemView) {
    super(itemView);
    ButterKnife.bind(this, itemView);
  }

  public Subscription bind(final ItemsItem item,final boolean isEnableBuyNow) {
    ...
    setFastBuyButton(isEnableBuyNow);
  ...
  private void setFastBuyButton(boolean isEnableBuyNow){
