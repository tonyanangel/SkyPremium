 ...
 */
@AutoValue
public abstract class TravelDetailViewState {
  @Nullable
  ...
  public static TravelDetailViewState create(Throwable error, CategoryResponse category,
  ...
  public static Builder builder() {
    return new AutoValue_TravelDetailViewState.Builder();
  }
  ...
  public abstract static class Builder {
    ...
    public abstract TravelDetailViewState build();
  }
}
