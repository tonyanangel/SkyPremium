...
public class CancellationPolicyDialogfordetailFragment extends DialogFragment {
    ...
    @Inject
    CancellationPolicyfordetailBuilder cancellationPolicyfordetailBuilder;
    private String propertyName;
    private List<CancelsPenalties> cancelsPenaltiesList;

    public CancellationPolicyDialogfordetailFragment() {
    ...
    public static CancellationPolicyDialogfordetailFragment newInstance(
            CancelPenalty cancelPenalty, String roomAndBed, String propertyName,List<CancelsPenalties> cancelsPenaltiesList) {
        CancellationPolicyDialogfordetailFragment fragment = new CancellationPolicyDialogfordetailFragment();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        tvPolicy.setText(cancellationPolicyfordetailBuilder.build(cancelPenalty, propertyName,cancelsPenaltiesList));
    }
