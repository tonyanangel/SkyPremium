...
package com.skypremiuminternational.app.app.internal.mvp.contract;
...
public interface Viewable<T> {
  ...
  void showForceUpdateNotice(String forceUpdateMessage, String url);

  void showUpdateNotice(String updateMessage, String url);
}
